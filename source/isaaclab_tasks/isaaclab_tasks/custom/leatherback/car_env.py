...
class LeatherbackEnvCfg(DirectRLEnvCfg):
    ...
    all_dof_name = ["Wheel__Upright__Rear_Right", "Wheel__Upright__Rear_Left", "Knuckle__Upright__Front_Right", "Knuckle__Upright__Front_Left"]
...
class LeatherbackEnv(DirectRLEnv):
    ...
    def __init__(self, cfg: LeatherbackEnvCfg, render_mode: str | None = None, **kwargs):
        ...
        self._wheel_dof_idx, _ = self.car.find_joints(self.cfg.wheels_dof_name)
        self._steering_dof_idx, _ = self.car.find_joints(self.cfg.steering_dof_name)
        self._all_dof_idx, _ = self.car.find_joints(self.cfg.all_dof_name)
